...
!!! info "情報"
    このマニュアルは、カルダノノードv10.5.3に対応しています。  
    最終更新日：2025年11月28日 guide version 13.8.9
...
=== "最小構成"
    ...
    | **CPU**   | 2Ghz/2コア以上のIntelまたはAMD x86プロセッサー|
    | **メモリ**    | 24GB |
    | **ストレージ**    | 350GB |
    | **ネットワーク**    | 10Mbps |
    | **帯域**    | 1時間あたり1GBの帯域 |
