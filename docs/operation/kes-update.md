...
ドキュメントとして記載しておきますが、<font color=red>**実運用では、半自動更新が可能な[SJG TOOL](../operation/tool.md/#spo-japan-guild-tool)の利用を推奨します。**</font>
...
## **12. チェックプログラム実行**
確認のため、**[SJG TOOL](../operation/tool.md/#spo-japan-guild-tool)**を実行します。
